...
def register():
    try:
        if request.method == 'POST':
            ...
            hashed_password = werkzeug.security.generate_password_hash(password=plain_password, method='pbkdf2:sha256',
                                                                       salt_length=8)
        ...
        flash('You have already signed up with this email, You should login in instead')
        time.sleep(2)
